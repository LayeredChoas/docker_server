...
## Table of Contents:
1. [What is docker_server](https://github.com/LayeredChoas/docker_server#what-is-docker_server-) ❔
    * [Description for newbies](https://github.com/LayeredChoas/docker_server#description-for-newbies-) 💡
2. [Instructions](https://github.com/LayeredChoas/docker_server#instructions-) 👈
    * [Installation](https://github.com/LayeredChoas/docker_server#-installation) 🔧
    * [Content](https://github.com/LayeredChoas/docker_server#-content) 📦
    * [Build Docker image](https://github.com/LayeredChoas/docker_server#-build-docker-image) 🐳
    * [Run a container](https://github.com/LayeredChoas/docker_server#-run-a-container) 🐳
    * [Shell acces to the container](https://github.com/LayeredChoas/docker_server#-shell-acces-to-the-container) 🐳
    * [Autoindex on/off](https://github.com/LayeredChoas/docker_server#-autoindex-onoff) 📂
3. [Guide: What I did step by step](https://github.com/LayeredChoas/docker_server#guide-what-i-did-step-by-step) ✔️
    * [Wiki](https://github.com/LayeredChoas/docker_server/wiki)
4. [How it looks](https://github.com/LayeredChoas/docker_server#how-it-looks-) 💻 
4. [Resources / Research](https://github.com/LayeredChoas/docker_server#resourcesresearch-) 🔍

# What is docker_server ❔

> [SUBJECT](en.subject.pdf)

The goal of docker_server is to create a web server with ```Nginx``` capable of running a ```WordPress``` website, ```phpMyAdmin```, and a ```MySQL``` database. This server will run in only one Docker container, under Debian Buster.
...
### 🔧 Installation 
```
git clone https://github.com/LayeredChoas/docker_server.git && cd docker_server
```
### 📦 Content  
...
### 🏃 Run a container
```
docker run --name docker_server -d -p 443:443 -p 80:80 docker_server
```
### 🐚 Shell acces to the container
```
docker exec -it docker_server bash
```
### 📁 Autoindex on/off
...
```
docker run --env AUTOINDEX=off --name docker_server -d -p 443:443 -p 80:80 docker_server
```
